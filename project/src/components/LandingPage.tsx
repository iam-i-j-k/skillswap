...
import { Achievement, TeamMember } from '../types';
...
function LandingPage() {    
    const onGetStarted = () => {
        ...
        console.log('Navigate to the "Get Started" page');
      ...
      >
        ...
        <div className="relative text-center text-white px-4">
          ...
          <button
            ...
            className="bg-purple-600 text-white px-8 py-3 rounded-lg font-medium text-lg hover:bg-purple-700 transition flex items-center space-x-2 mx-auto"
          >
